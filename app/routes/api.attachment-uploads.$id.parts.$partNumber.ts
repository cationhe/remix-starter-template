...
import { attachmentLimits, getAttachmentsBucket, getUploadRecord, saveUploadedPart } from "~/lib/attachments.server";
...
export async function action({ request, context, params }: ActionFunctionArgs) {
	...
	try {
		...
		await saveUploadedPart({ context, uploadRecordId, partNumber, etag: part.etag, sizeBytes });
